/* **********************************************************
 * Description : MF_TC079.cs test case for 
...
namespace NationalVision.Automation.Tests.Cases.MyFavourite
{
    /// <summary>
    /// Description : MF_TC079.cs test case for 
    ///               Verify if an existing user is able to create, delete try on,
    ///               update try on and shop with try on from Favourites Page
    /// </summary>
    class MF_TC079 : BaseCase
    {
        protected override void ExecuteTestCase()
        {
            ...
            Step = "Click 'Update Try on' of default try on in 'Manage Try ons' sections";
            Selenide.Click(Driver, Util.GetLocator("CreateTryOnBtn"));
